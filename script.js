...
async function sendMessage() {
    ...
    //Change animation to CavemanTalk.gif while bot is "thinking" to create a speaking effect
    ...
    try {
        ...
        //Revert animation back to CavemanIdle.gif after response is displayed
